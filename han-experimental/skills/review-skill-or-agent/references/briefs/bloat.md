...
to skim) over the entire artifact even under change scope, since structural drift is invisible in a diff; when the scope
is a change, mark any big-fish finding that lands only in unchanged regions as advisory. Scan the intro and framing
prose as closely as the numbered steps, since restatement and audience-mismatched asides hide in framing that reads as
