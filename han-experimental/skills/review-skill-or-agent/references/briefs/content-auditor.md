...
whether the edit dropped a load-bearing instruction or rule. Frontmatter and tool-grant conformance belong to the
conformance & quality reviewer; don't raise them.
