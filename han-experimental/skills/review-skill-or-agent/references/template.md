...
Findings: X critical, X warnings, X suggestions, X legibility, X bloat (of them X critical). Critical, warnings, and
suggestions are defects and gate the recommendation; legibility and bloat are advisory.
...
<!-- Conformance & quality reviewer did not return (Step 4/7): "This review is blocked — the conformance & quality pass did not complete, so guidance conformance and execution safety are unverified. Do not treat this as a pass." This overrides every case below. -->
...
{what is duplicated/restated/filler or the split proposed, and the consolidation; for a big fish, the local instances it
rolls up}
