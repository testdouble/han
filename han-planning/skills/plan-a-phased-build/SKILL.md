...
**kind** (foundation / feature slice / polish / deferral), **demonstrability** (one sentence on what the demo is), and
**depends-on** (other candidate phases that must come first).
