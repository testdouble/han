...
- [Skill Composition](../../../han-plugin-builder/skills/guidance/references/skill-building-guidance/skill-composition.md) — When a skill may call another skill via the Skill tool: orchestration composition (supported, with discipline) versus data-fetch composition (avoid, discover inline). Read before reaching for a sub-skill call.
