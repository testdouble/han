...
Maps a changed file path to the documentation entities that must be reviewed for accuracy. Used in **branch mode**,
where the skill audits only the entities the branch touched. In **sweep mode**, the skill enumerates the full inventory
instead.
