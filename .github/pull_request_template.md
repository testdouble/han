...
- [ ] Confirm the writing follows [`han-communication/references/writing-voice.md`](../han-communication/references/writing-voice.md). Em-dashes only as a label-gloss separator or an appositive aside. No banned words ("actually", "just", "leverage", "utilize", "showcase", "robust" as vague positive, "It's worth noting", "Importantly").
