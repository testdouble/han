...
definition at
[`han-atlassian/skills/project-documentation-to-confluence/SKILL.md`](../../skills/project-documentation-to-confluence/SKILL.md).
...
- [`/project-discovery`](../../../han-core/docs/skills/project-discovery.md). Run first so the documentation pass finds the docs directory
  and stack language.
...
- [`SKILL.md` for /project-documentation-to-confluence](../../skills/project-documentation-to-confluence/SKILL.md).
