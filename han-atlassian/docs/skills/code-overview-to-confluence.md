...
[`han-atlassian/skills/code-overview-to-confluence/SKILL.md`](../../skills/code-overview-to-confluence/SKILL.md).
...
- **What it does.** Runs the core [`/code-overview`](../../../han-coding/docs/skills/code-overview.md) skill to produce a
...
- **A thin orchestrator over two skills.** The overview work (target resolution, mode and size selection, the parallel
  ...
  [`/code-overview`](../../../han-coding/docs/skills/code-overview.md). The publishing work, the location resolution, and the
...
- **It explains code, it does not review or change it.** `/code-overview` is read-only and raises no findings,
  ...
  quality review, use [`/code-review`](../../../han-coding/docs/skills/code-review.md); to post a review to a PR, use
...
- **A local-only overview.** Use [`/code-overview`](../../../han-coding/docs/skills/code-overview.md). This skill is for when the overview
...
- **Reviewing code quality.** Use [`/code-review`](../../../han-coding/docs/skills/code-review.md), or
  [`/post-code-review-to-pr`](../../../han-github/docs/skills/post-code-review-to-pr.md) to post a review to a PR. This skill explains; it
  does not judge.
...
- **The working draft.** A markdown overview in a scratch file outside your repo (for example
  `${TMPDIR:-/tmp}/code-overview-<slug>.md`) that [`/code-overview`](../../../han-coding/docs/skills/code-overview.md) writes. In code mode, it
...
- **Reach for the right neighbor when you need judgment.** This skill explains; it raises no findings. When you need a
  quality review, run [`/code-review`](../../../han-coding/docs/skills/code-review.md); when you need architectural assessment, run
  [`/architectural-analysis`](../../../han-coding/docs/skills/architectural-analysis.md).

## Cost and latency

The skill itself dispatches no agents. Its cost is whatever [`/code-overview`](../../../han-coding/docs/skills/code-overview.md) costs:
...
- [`/code-overview`](../../../han-coding/docs/skills/code-overview.md). The core skill this one runs to produce the overview. Use it
...
- [`SKILL.md` for /code-overview-to-confluence](../../skills/code-overview-to-confluence/SKILL.md). The
