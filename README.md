...
| `han.plugin-builder` | opt-in | carries the guidance for building your own skills, agents, and plugins, plus the `skill-builder` and `agent-builder` interview skills |
