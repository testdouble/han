...
See also: [Extend Han with Plugin Dependencies](../../how-to/extend-han-with-plugin-dependencies.md) for how the field works with Han's own plugins as the worked example, and [Build a plugin that depends on Han](../../how-to/build-a-plugin-that-depends-on-han.md) for the hands-on walkthrough.
