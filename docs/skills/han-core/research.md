...
- [`readability-editor`](../../agents/han-communication/readability-editor.md). Dispatched after validation to rewrite the report draft against the shared readability standard, preserving every fact and citation identifier.
