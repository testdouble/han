...
- **Specifying the feature.** Use [`/plan-a-feature`](./plan-a-feature.md) instead.
- **Generating a PR description or other GitHub artifact.** Use [`/update-pr-description`](./update-pr-description.md).
