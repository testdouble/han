...
- [`readability-editor`](../../agents/han-communication/readability-editor.md). Dispatched after synthesis to rewrite the report's synthesized prose against the shared readability standard, leaving each analysis section's verbatim agent output unchanged.
