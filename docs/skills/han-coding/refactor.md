...
[`han-coding/skills/refactor/SKILL.md`](../../../han-coding/skills/refactor/SKILL.md).
...
- A [`/code-review`](../han-coding/code-review.md) or
  [`/architectural-analysis`](../han-coding/architectural-analysis.md) run produced refactoring recommendations you want
  executed.
...
- **Finding out what to refactor.** Use [`/code-review`](../han-coding/code-review.md) or
  [`/architectural-analysis`](../han-coding/architectural-analysis.md) to produce the findings; this skill executes
  them.
- **Fixing a bug.** A fix changes behavior, which this skill never does. Use
  [`/investigate`](../han-coding/investigate.md) and then drive the fix in with [`/tdd`](./tdd.md).
...
the deferrals appear in the final summary. See [YAGNI](../../yagni.md) for the two gates, the acceptable-evidence list,
...
The skill fills a specific gap in the suite. [`/code-review`](../han-coding/code-review.md) and
[`/architectural-analysis`](../han-coding/architectural-analysis.md) recommend refactorings but never modify code; the
...
[docs/research/refactor-skill-research.md](../../research/refactor-skill-research.md).
...
with validation is in [docs/research/refactor-skill-research.md](../../research/refactor-skill-research.md).
...
- [YAGNI](../../yagni.md). The evidence gate every planned refactoring passes, with the named anti-patterns and the
  deferral format.
...
- [`/code-review`](../han-coding/code-review.md) and
  [`/architectural-analysis`](../han-coding/architectural-analysis.md). Where the strongest input comes from: their
  findings are this skill's work orders.
- [`/investigate`](../han-coding/investigate.md). For when the "refactoring" you want is really a bug to diagnose and
  fix.
- [Research: refactor skill design](../../research/refactor-skill-research.md). The evidence-based, adversarially
