...
[`han-coding/skills/test-planning/SKILL.md`](../../../han-coding/skills/test-planning/SKILL.md).
...
- **Iterating on an existing test plan.** Use [`/iterative-plan-review`](../han-planning/iterative-plan-review.md) for
  multi-pass refinement of a written plan.
- **Writing test code.** This skill produces a plan only. Write the tests separately.
- **Architectural testability analysis.** Use [`/architectural-analysis`](../han-coding/architectural-analysis.md) for
...
4. **Generate output.** Fill the template at
   [`references/template.md`](../../../han-coding/skills/test-planning/references/template.md), leading with plain
...
5. **Review the output.** Dispatch [`information-architect`](../../agents/han-core/information-architect.md) and
...
- [`test-engineer`](../../agents/han-core/test-engineer.md),
  [`edge-case-explorer`](../../agents/han-core/edge-case-explorer.md). Always dispatched.
- [`concurrency-analyst`](../../agents/han-core/concurrency-analyst.md). Dispatched when the file list touches async,
  threads, or shared state.
- [`adversarial-security-analyst`](../../agents/han-core/adversarial-security-analyst.md). Dispatched when the file list
