...
[`han-planning/skills/plan-work-items/SKILL.md`](../../../han-planning/skills/plan-work-items/SKILL.md).
...
- [`/work-items-to-issues`](../han-github/work-items-to-issues.md). Pair downstream to publish the work items as GitHub
  issues. Part of the `han-github` plugin.
- [Work item template](../../../han-planning/skills/plan-work-items/references/work-item-template.md). The template the
  skill renders for each work item.
- [Work-items file format](../../../han-planning/skills/plan-work-items/references/work-items-file-format.md). The
  title, intro, and preamble structure of the output file.
- [Reference artifact inventory](../../../han-planning/skills/plan-work-items/references/reference-artifact-inventory.md).
