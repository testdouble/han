...
Skills for analyzing a module's architecture or comparing two artifacts.
...
The coding layer: the skills you reach for while working in code. Writing it, reviewing it, testing it, investigating it, and standardizing it. Depends on `han.core`; bundled by the `han` meta-plugin.
