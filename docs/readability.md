...
| [`/design-an-api`](../han-coding/docs/skills/design-an-api.md)                                        | The engineer who will implement the contract and the reviewer who will approve it         | Synthesis: dispatches `readability-editor`                                |
...
| [`/plan-a-change`](../han-planning/docs/skills/plan-a-change.md)                                      | The engineer who will make the change                                                     | Synthesis: dispatches `readability-editor`                                |
...
| [`/ddd-analysis`](../han-ddd/docs/skills/ddd-analysis.md)                                             | The engineer or product manager reading the context model and deciding what to do next    | Synthesis: dispatches `readability-editor`                                |
