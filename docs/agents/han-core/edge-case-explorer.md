...
[`han-core/agents/edge-case-explorer.md`](../../../han-core/agents/edge-case-explorer.md).
...
- [`/plan-a-feature`](../../skills/han-planning/plan-a-feature.md). Dispatches this agent as part of the spec-stage
  team, covering Outcome / Primary Flow / Alternate Flows / Edge Cases.
- [`/plan-implementation`](../../skills/han-planning/plan-implementation.md). Dispatches this agent as part of the
  implementation team.
