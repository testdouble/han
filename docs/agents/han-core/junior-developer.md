...
[`han-core/agents/junior-developer.md`](../../../han-core/agents/junior-developer.md).
...
Alongside the YAGNI sweep, the agent applies the companion [evidence rule](../../evidence.md) to characterize each
...
- [`/plan-a-feature`](../../skills/han-planning/plan-a-feature.md) and
  [`/plan-implementation`](../../skills/han-planning/plan-implementation.md). Skills that always include this agent in
  their review rounds.
- [`/code-overview`](../../skills/han-coding/code-overview.md). Dispatches this agent (with `information-architect`) to
