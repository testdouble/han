...
[`han-core/agents/test-engineer.md`](../../../han-core/agents/test-engineer.md).
...
- [`/plan-implementation`](../../skills/han-planning/plan-implementation.md). Dispatches this agent for the
...
- [`/iterative-plan-review`](../../skills/han-planning/iterative-plan-review.md). Makes this agent available as a
