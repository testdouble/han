...
[`han-core/agents/risk-analyst.md`](../../../han-core/agents/risk-analyst.md).
...
- [`/architectural-decision-record`](../../skills/han-core/architectural-decision-record.md). Dispatches this agent for
  ADR risk scoring.
- [`/plan-a-feature`](../../skills/han-planning/plan-a-feature.md). Conditionally dispatches this agent when the feature
