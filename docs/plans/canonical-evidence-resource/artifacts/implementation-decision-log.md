...
- **Evidence:** `plugin/references/yagni-rule.md` (101 lines, zero explanatory content); `docs/yagni.md:17–24` (Why section absent from rule file); `docs/guidance/skill-building-guidance/context-hygiene.md` ("focused context outperforms accumulated context"); `docs/guidance/skill-building-guidance/progressive-disclosure.md` (Level 3 references load on demand).
