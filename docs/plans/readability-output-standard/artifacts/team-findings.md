...
- **Resolution:** Generalized the frame to "a capable reader who did not do this work and lacks the author's context," and allowed per-skill and per-section sharpening. Recorded the per-skill sharpening as Open Item OI-2.
- **Resolved by:** evidence
