...
Han's specialist sub-agents are built to fill those role gaps. When you run [`/code-review`](./skills/code-review.md), the skill dispatches [`adversarial-security-analyst`](./agents/adversarial-security-analyst.md), [`devops-engineer`](./agents/devops-engineer.md), [`on-call-engineer`](./agents/on-call-engineer.md), [`data-engineer`](./agents/data-engineer.md), [`test-engineer`](./agents/test-engineer.md), [`edge-case-explorer`](./agents/edge-case-explorer.md), and the [`structural-analyst`](./agents/structural-analyst.md), [`behavioral-analyst`](./agents/behavioral-analyst.md), and [`concurrency-analyst`](./agents/concurrency-analyst.md) at the size of your branch. Each one reads the changes from its own perspective and surfaces findings. When you run [`/plan-a-feature`](./skills/plan-a-feature.md), [`project-manager`](./agents/project-manager.md) runs the discussion, [`junior-developer`](./agents/junior-developer.md) stress-tests the assumptions, and three to five specialists chosen by what the feature touches push back on the design. When you run [`/investigate`](./skills/investigate.md), [`evidence-based-investigator`](./agents/evidence-based-investigator.md) gathers the facts and [`adversarial-validator`](./agents/adversarial-validator.md) argues that the proposed fix will not fix the bug.
