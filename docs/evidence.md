...
These trust classes are the same ones [`/research`](./skills/han-core/research.md) already uses. The canonical rule
...
- [`/research`](./skills/han-core/research.md). The skill where the trust classes and the corroboration gate originated.
